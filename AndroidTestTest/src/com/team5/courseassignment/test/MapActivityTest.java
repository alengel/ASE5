...
public class MapActivityTest extends
	...
	protected void setUp() throws Exception {
		...
		mSettingsMenu = mActivity
				.findViewById(com.team5.courseassignment.R.id.action_settings);
		mProfileMenu = mActivity
				.findViewById(com.team5.courseassignment.R.id.action_profile);
	}
	...
	public void testProfileMenu() throws Exception {
		...
		ActivityMonitor activityMonitor = new ActivityMonitor(
				ProfileActivity.class.getName(), null, true);
