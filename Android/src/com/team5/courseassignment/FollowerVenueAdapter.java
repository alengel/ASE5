...
public class FollowerVenueAdapter extends ArrayAdapter<FollowerProfileVenue> {
	  ...
	  public FollowerVenueAdapter(Context context, int resourceId, List<FollowerProfileVenue> mediaItems) {
	  ...
	  public View getView(int position, View convertView, ViewGroup parent) {
	    ...
	    try {
	      cachedImage = imageLoader.loadImage(item.getLocationImage(), new ImageLoadedListener() {
