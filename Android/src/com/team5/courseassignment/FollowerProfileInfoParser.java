...
public class FollowerProfileInfoParser {
	...
	public List<FollowerProfileInfo> parseJSON(JSONObject results) throws JSONException {
		...
		FollowerProfileInfo followerProfileInfo = new FollowerProfileInfo(profileImage, firstName, lastName);
