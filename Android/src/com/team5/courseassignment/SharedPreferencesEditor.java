...
public class SharedPreferencesEditor {
	 ...
	 * @param context
	 * @param the
	 *            key that is needed to contact the server (authentication)
	 */
	public SharedPreferencesEditor(Context context, String key) {
		super();
		this.kSharedPreferences = context.getSharedPreferences(
				kSHARED_PREFERENCES_NAME, 0);
	...
	public int getInterval() {
		...
		if (result == DEFAULT_VALUE) {
			...
			ProgressDialog progress = ProgressDialog.show(null, "Please wait",
					"Loading ...");
	...
	private class SetSettingsAsyncTask extends
			AsyncTask<List<NameValuePair>, Void, JSONObject> {
		private ProgressDialog progress;
